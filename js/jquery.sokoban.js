...
(function($){
  ...
  $.fn.sokoban = function (originalLevels, reset, level) {
    debugger;
    var item = 0;
    ...
    return this.each(function(){
      var elm = $( this ),
          ...
          if(reset)
          {
            elm[0].innerText = originalLevels[item];
            item++;
            elm.data( 'sokoban', new Sokoban( this, reset ) );
          }
          else
          {
  ...
  {
    var elm = $(this[level-1])
        ctl = elm.data ('sokoban');
        elm[0].innerText = originalLevels[level-1];
        elm.data('sokoban', new Sokoban(this[level-1], reset));
  }
  };
